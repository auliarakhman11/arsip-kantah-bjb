...
<body class="hold-transition sidebar-mini layout-fixed layout-navbar-fixed layout-footer-fixed" id="ini_body">
    <div class="wrapper">
        ...
        <footer class="main-footer">
            <strong>Copyright &copy; 2025 <a href="">Kantor Pertanahan Kota Banjarbaru</a>.</strong>
            All rights reserved.
        </footer>
    </div>
    <!-- ./wrapper -->
...
<script src="{{ asset('adminlte') }}/plugins/jquery-mapael/maps/usa_states.min.js"></script> --}}
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            //date picker
            $(function() {
                $("input[name='print']").daterangepicker({
                    opens: 'up',
                    drops: 'up'
                }, function(start, end, label) {

                });
                $('#print').daterangepicker();
                $('#print').on('apply.daterangepicker', function(ev, print) {

                    document.getElementById("tgl1").value = print.startDate.format('YYYY-MM-DD');
                    document.getElementById("tgl2").value = print.endDate.format('YYYY-MM-DD');
                });
            });
            //end date picker
    ...
    <script>
        $(document).ready(function() {
            ...
            const dr = localStorage.getItem('dark_mode');
