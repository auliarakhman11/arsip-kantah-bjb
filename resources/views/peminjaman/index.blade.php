...
@section('content')
        ...
        <div class="row justify-content-center">
            ...
            <div class="col-12">
              ...
              <ul class="nav nav-tabs" id="myTab" role="tablist">
                <li class="nav-item">
                  <a class="nav-link active" id="tambah_peminjaman-tab" data-toggle="tab" href="#tambah_peminjaman" role="tab" aria-controls="tambah_peminjaman" aria-selected="true">Tambah Peminjaman</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" id="get_pengajuan" data-toggle="tab" href="#pengajuan" role="tab" aria-controls="pengajuan" aria-selected="false">Pengajuan</a>
                </li>
              ...
              <div class="tab-content" id="myTabContent">
                ...
                <div class="tab-pane fade show active" id="tambah_peminjaman" role="tabpanel" aria-labelledby="tambah_peminjaman-tab">
                            ...
                            <div class="row">
                                        ...
                                        <div class="col-9">
                                            <select name="kecamatan_id" id="kecamatan_id" class="form-control select2bs4" required>
                                              <option value="">Pilih Kecamatan..</option>
                                                ...
                                                <option value="{{ $k->id }}|{{ $k->nm_kecamatan }}" >{{ $k->nm_kecamatan }}</option> 
                                                @endforeach
                                              </select>
                                        </div>
                                    </div>
                                ...
                                <div class="col-6 mb-2">
                                  <div class="row">
                                      ...
                                      <div class="col-9">
                                          <select name="pelayanan_id" class="form-control select2bs4" required>
                                            <option value="">Pilih pelayanan...</option>
                                              @foreach ($pelayanan as $p)
                                              <option value="{{ $p->id }}|{{ $p->nm_pelayanan }}" >{{ $p->nm_pelayanan }}</option> 
                                              @endforeach
                                            </select>
                                      </div>
                                  </div>
                                    ...
                                    <div class="col-9">
                                        <select name="hak_id" class="form-control select2bs4" required>
                                          <option value="">Pilih tipe Hak...</option>
                                            @foreach ($hak as $k)
                                            <option value="{{ $k->id }}|{{ $k->nm_hak }}" >{{ $k->nm_hak }}</option> 
                                            @endforeach
                                          </select>
                                    </div>
                                </div>
                              ...
                              <div class="col-6 mb-2">
                                <div class="row">
                                    ...
                                    <div class="col-9">
                                        <input type="text" class="form-control" name="no_hak" required>
                                    </div>
                                </div>
                              </div>
                              ...
                              <div class="col-6 mb-2">
                                <button type="submit" id="cari_peminjaman" class="btn btn-sm btn-primary float-right">
                  ...
                  <div class="card">
                    ...
                    <div class="card-body">
                      <div class="table-responsive">
                        <table class="table table-sm" width="100%" id="pengajuan_table" style="font-size: 13px;">
  ...
  <!-- /.content-wrapper -->
    ...
    <div class="modal fade" id="modal_cek_status_arsip" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    ...
    <div class="modal fade" id="modal_terima_kirim" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header bg-primary">
            ...
            <button type="submit" value="Tidak" name="tombol" class="btn btn-warning" id="btn-tidak-kirim">Tidak</button>
            </form>
            
            <form id="form-terima-kirim" class="d-inline-block">
              <input type="hidden" name="id_peminjaman" class="id_peminjaman">
            <button type="submit" value="Terima" name="tombol" class="btn btn-primary" id="btn-terima-kirim">Terima</button>
            </form>
    ...
    <div class="modal fade" id="modal_batal_pengajuan" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog" role="document">
      <div class="modal-content">
          <div class="modal-header bg-primary">
                    ...
                    $.ajax({
                        ...
                        success: function(data) {
                          if(data){
                            ...
                            $('#btn_lanjut_peminjaman').html('<i class="fas fa-arrow-alt-circle-right"></i> Lanjut');
