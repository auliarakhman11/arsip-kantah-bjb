        ...
        <div class="row justify-content-center">
            ...
            <div class="col-12">
              ...
              <ul class="nav nav-tabs" id="myTab" role="tablist">
                <li class="nav-item">
                  <a class="nav-link active" id="get_peminjaman" data-toggle="tab" href="#peminjaman" role="tab" aria-controls="peminjaman" aria-selected="true">Peminjaman</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" id="nav_selesai" data-toggle="tab" href="#selesai" role="tab" aria-controls="selesai" aria-selected="false">Selesai</a>
                </li>                
              </ul>
                ...
                <div class="tab-pane fade show active" id="peminjaman" role="tabpanel" aria-labelledby="peminjaman-tab">
                  <div class="card">
                    <div class="card-header">
                      ...
                      <a href="#modal-print" data-toggle="modal" class="btn btn-sm btn-info float-right"><i class="fas fa-print"></i> Print</a>
                    </div>
                    <div class="card-body">
                      <div class="table-responsive">
                        <table class="table table-sm text-center" width="100%" id="table_peminjaman" style="font-size: 13px;">
                          <thead>
                            <tr>
                              <th>#</th>
                              {{-- <th width="0.1%"></th> --}}
                ...
                <div class="tab-pane fade" id="selesai" role="tabpanel" aria-labelledby="selesai-tab">
                  <div class="card">
                    ...
                    <div class="card-body">
                      ...
                      <div class="table-responsive">
                        <table class="table table-sm" width="100%" id="selesai_table" style="font-size: 13px;">
                          <thead>
                              <tr>
                                  <th>#</th>
                                  {{-- <th width="0.1%"></th> --}}
...
<form action="{{ route('printDataPeminjaman') }}" method="get">
  <div class="modal fade" id="modal-print" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    ...
    <div class="modal-content">
          ...
          <div class="form-group">
            <table>
              <tr>
                ...
                <td>:</td>
                <td> <input style="width: 350px;" class="form-control" type="input" value="{{ date('Y-m-d') }}" id="print"></td>
              </tr>
            </table>
      ...
      <div class="modal fade" id="modal_pengembalian" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
          <div class="modal-dialog" role="document">
          <div class="modal-content">
              <div class="modal-header bg-primary">
              ...
              <div class="modal-body">
                  <div class="row">
                    ...
                    <form id="form-forward">
                      <div class="row">
                        <div class="col-8">
                          ...
                          <select name="seksi_pelayanan" class="form-control form-control-sm select2bs4" required>
                            <option value="">-Pilih Seksi-</option>
                            @foreach ($seksi as $d)
                            <option value="{{ $d->id }}|{{ $d->seksi->id }}">{{ $d->seksi->nm_seksi }}-{{ $d->nm_pelayanan }}</option>
                            @endforeach
                          </select>
                        </div>
                        <div class="col-4">
                          <button id="btn-forward" type="submit" class="btn btn-sm btn-warning float-left"><i class="fas fa-share-square"></i> Forward</button>
                        </div>
                      </div>
                    </form>
                    </div>
                    <div class="col-4">
                      ...
                      <input type="hidden" name="id_peminjaman" class="id_pengembalian">
                      <button type="submit" class="btn btn-sm btn-primary float-right" id="btn-pengembalian">Kembalikan</button>
                      </form>
                    </div>
                  </div>
      ...
      <div class="modal fade" id="modal_terima_forward" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header bg-primary">
        ...
        <form id="upload_arsip">
          <div class="modal fade" id="modal_upload_arsip" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header bg-primary">
                ...
                event.preventDefault();
                    ...
                    $.ajax({
                        ...
                        success: function(data) {
                            ...
                            $('#btn-forward').html('<i class="fas fa-share-square"></i> Forward'); //tombol
                            getPeminjaman();
                            getDashboard();
                            Swal.fire({
                                toast: true,
    ...
    $(document).on('click', '#nav_selesai', function() {
        ...
        $(document).on('submit', '#upload_arsip', function(event) {
                event.preventDefault();
                    ...
                    $('#btn_upload_arsip').html('Loading <div class="ld"><div></div><div></div><div></div></div>');
                    $.ajax({
