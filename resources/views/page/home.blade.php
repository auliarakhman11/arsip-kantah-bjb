        ...
        <div class="row justify-content-center">
            <div class="col-12">
              <ul class="nav nav-tabs" id="myTab" role="tablist">
                ...
                <li class="nav-item">
                  <a class="nav-link" id="nav_dikirim" data-toggle="tab" href="#dikirim" role="tab" aria-controls="dikirim" aria-selected="false">Dikirim</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" id="nav_peminjaman" data-toggle="tab" href="#peminjaman" role="tab" aria-controls="peminjaman" aria-selected="false">Peminjaman</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" id="nav_forward" data-toggle="tab" href="#forward" role="tab" aria-controls="forward" aria-selected="false">Forward</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" id="nav_pengembalian" data-toggle="tab" href="#pengembalian" role="tab" aria-controls="pengembalian" aria-selected="false">Pengembalian</a>
                </li>
                <li class="nav-item">
                          ...
                          <div class="col-md-6 col-12 ">
                            <div class="row">
                              ...
                              <div class="col-md-4 col-5">
                                <a class="btn btn-sm btn-secondary float-right" target="_blank" href="{{ route('printAllPengajuan') }}"><i class="fas fa-print"></i> Print Semua</a>
                              </div>
                            </div>
                  ...
                  <div class="card">
                    ...
                    <div class="card-body">
                      ...
                      <div class="table-responsive">
                        <table class="table table-sm" width="100%" id="dikirim_table" style="font-size: 13px;">
                          <thead>
                              <tr>
                                  <th>#</th>
                                  {{-- <th width="0.1%"></th> --}}
                ...
                <div class="tab-pane fade" id="peminjaman" role="tabpanel" aria-labelledby="peminjaman-tab">
                  <div class="card">
                    ...
                    <div class="card-body">
                      ...
                      <div class="table-responsive">
                        <table class="table table-sm" width="100%" id="peminjaman_table" style="font-size: 13px;">
                          <thead>
                              <tr>
                                  <th>#</th>
                                  {{-- <th width="0.1%"></th> --}}
                ...
                <div class="tab-pane fade" id="forward" role="tabpanel" aria-labelledby="forward-tab">
                  <div class="card">
                    ...
                    <div class="card-body">
                      ...
                      <div class="table-responsive">
                        <table class="table table-sm" width="100%" id="forward_table" style="font-size: 13px;">
                          <thead>
                              <tr>
                                  <th>#</th>
                                  {{-- <th width="0.1%"></th> --}}
                ...
                <div class="tab-pane fade" id="pengembalian" role="tabpanel" aria-labelledby="pengembalian-tab">
                  <div class="card">
                    ...
                    <div class="card-body">
                      ...
                      <div class="table-responsive">
                        <table class="table table-sm" width="100%" id="pengembalian_table" style="font-size: 13px;">
                          <thead>
                              <tr>
                                  <th>#</th>
                                  {{-- <th width="0.1%"></th> --}}
                ...
                <div class="tab-pane fade" id="selesai" role="tabpanel" aria-labelledby="selesai-tab">
                  <div class="card">
                    <div class="card-header">
                      ...
                      <button class="btn btn-primary btn-sm float-right" data-toggle="modal" data-target="#modal-excel"><i class="fas fa-file-excel"></i> Export</button>
                    </div>
                    <div class="card-body">
