                ...
                <div class="card">
                  ...
                  @endif --}}
                    <div class="card-header">
                        <h5 class="float-left">List Surat Tugas</h5>
                    </div>
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-sm" id="table_st" width="100%">
                                <thead>
                                    <tr>
                                        <th>#</th>
                                        <!--<th width="0.1%"></th>-->
  ...
  <form id="form_ba_st" method="POST">
    ...
    <div class="modal fade" id="modal_ba_st" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <h5 class="modal-title" id="exampleModalLabel">Data Surat Tugas</h5>
        ...
        $(document).on('click', '.btn_ba_st', function() {
            ...
            $.get('get-dt-peminjaman?no_hak=' + no_hak+'&hak_id='+hak_id+'&kecamatan_id='+kecamatan_id+'&kelurahan_id='+kelurahan_id+'&no_tiket='+no_tiket, function (data) {
                ...
                if(data){
                    ...
                    $("#form_ba_st").attr('action', "{{ route('editPdfSt') }}");
                }else{
                    $('#no_hak').val(no_hak);
                    $('#hak_id').val(hak_id);
                    ...
                    $("#form_ba_st").attr('action', "{{ route('addPdfSt') }}");
                }
